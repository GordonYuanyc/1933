...
public class BouncingBall extends AnimationFrame{
	...
	public static void main(String[] args){
		BouncingBall bb= new BouncingBall(1800,1800,"Bouncing Ball");
		bb.start();
	}
	...
	public void action(){
		...
		if ( ballX<BORDER || ballX+ballSize>getHeight()-BORDER ){//bounce left or right
			ballXSpeed*=-1;//speedy doesn't change, reverse speedx
		}
		if ( ballY<BORDER || ballY+ballSize>getWidth()-BORDER ){//bounce up or down
			ballYSpeed*=-1;//speedx doesn't change, reverse speedy
		}
