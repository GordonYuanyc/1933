...
public class tryStrategy implements IStrategy {
    ...
    public void takeTurn(List<IPlanet> planets, IPlanetOperations planetOperations, Queue<IEvent> eventsToExecute) {
        ...
        eventsToExecute.offer(planetOperations.transferPeople(conqueredVisiblePlanets.get(0), unconqueredVisiblePlanets.get(unconqueredVisiblePlanets.size()-1), 1));
    }
